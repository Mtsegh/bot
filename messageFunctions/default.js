...
const callback_default = async (bot, data, parsedData, chatId, messageId) => {
    ...
    if (parsedData) {
        if (parsedData.type === 'airtimeOpt') {
            await bot.editMessageText("Enter Receiver's Phone Number", {
                chat_id: chatId,
            ...
            switch (parsedData.value) {
                case 'buy':
                    ...
                    bot.editMessageText("Write in detail the fault you encountered", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
                ...
                case 'manualTrans':
                    ...
                    bot.editMessageText("Reply with your bank name and the amount you sent.", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
                ...
                case 'autoTrans':
                    ...
                    bot.editMessageText("Sorry for the inconvenience. Reply with the amount you sent and the day you sent it.", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
                ...
                case 'accountIssue':
                    ...
                    bot.editMessageText("Write in detail the poblem you are having with your account.", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
                ...
                case 'support':
                    ...
                    bot.editMessageText("How may we help you.", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
                ...
                default:
                    ...
                    await bot.editMessageText("Invalid selection. Please choose a valid option.", {
                        chat_id: chatId,
                        message_id: messageId,
                        reply_markup: JSON.stringify({
                            inline_keyboard: [
        ...
        if (state.isPhone && state.phone) {
            ...
            await bot.editMessageText(`Confirm your request for ₦${data} Airtime to ${state.phone}:\nEnter your passcode to Pay ₦${data}`, {
                    chat_id: chatId,
                    message_id: messageId,
                    reply_markup: options.reply_markup,
            }).then(async()=>{
        ...
        await bot.editMessageText('Select Data plan:', {
            chat_id: chatId,
            message_id: messageId,
            reply_markup: options.reply_markup,
        });
